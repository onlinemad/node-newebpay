...
_newebpay.prototype.CheckCode = function (type) {
  ...
  if  (type === 'winning_request') {
    ...
    str = qs.stringify(Object.assign({ HashIV: this.iv }, Object.keys(this._trade_info).sort().reduce((r, k) => (r[k] = this._trade_info[k], r), {}), { HashKey: this.key })).replace(/%20/g, '+')
  }
  console.log(str)
